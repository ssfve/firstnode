...
let savePDFInfo = function (req, res) {
    ...
    let modSql = 'INSERT INTO upload_pdf_table (mode_no,source_detail,gstone_id,cover_bit,fix_mode)' +
        ' values (?,?,?,?,?)';
    let modSqlParams = [params.mod_name, params.source_detail, params.gstone_id, params.cover_bit, params.fix_mode];
...
router.get('/savePDFInfo', [savePDFInfo]);
